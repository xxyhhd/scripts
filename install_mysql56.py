...
def modify_passwd():
    os.system('/home/mysqls/mysql{0}/service/bin/mysql -uroot -S /tmp/mysql{0}.sock -P{0} -e \"update mysql.user set password = PASSWORD(\'123456\'), host = \'%\' where user = \'root\';flush privileges;\"'.format(db_port))
